...
class LinkedinPCrawlClient extends GenericPCrawlClient
{
	constructor()
	{
		super('https://www.linkedin.com/', true);
	}

	async fetchUsername(name="markbarrera")
	{
		var tagUrl = 'in/'+name;
...
module.exports = LinkedinPCrawlClient;