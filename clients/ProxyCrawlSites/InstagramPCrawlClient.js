var GenericPCrawlClient = require('./GenericPCrawlClient.js');
// const md5 		= require('md5');
const moment 	= require('moment');
var feedID;

class InstagramPCrawlClient extends GenericPCrawlClient
{
	constructor()
	{
		super('https://www.instagram.com/', true);
	}

	async fetchHashtag(hashtag)
	{
		var tagUrl = 'explore/tags/'+hashtag+'?__a=1';
		this.fetchContent(tagUrl)
		.then(console.log);
	}
...
module.exports = InstagramPCrawlClient;